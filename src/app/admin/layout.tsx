    ...
    return (
      <div className="min-h-screen bg-slate-950 flex items-center justify-center p-4">
        <div className="text-center max-w-md">
          ...
          <p className="text-slate-400 mb-6">Bạn không có quyền truy cập trang admin. Chỉ admin và teacher mới có thể sử dụng chức năng này.</p>
          <button
            onClick={() => router.push('/')}
          ...
          <div className="border-t border-slate-800 p-3 space-y-2">
            {sidebarOpen && (
              <div className="px-3 py-2 bg-slate-800/50 rounded-lg mb-2">
                <p className="text-xs text-slate-400 uppercase font-semibold tracking-wide">Đăng nhập</p>
                <p className="text-sm text-slate-100 font-medium mt-1">{user?.full_name}</p>
