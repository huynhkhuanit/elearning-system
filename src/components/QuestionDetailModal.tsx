...
import { X, ThumbsUp, MessageCircle, CheckCircle2, Clock, Send, ArrowLeft, Award } from "lucide-react"
...
export default function QuestionDetailModal({ isOpen, onClose, onBack, questionId, onUpdate }: QuestionDetailModalProps) {
          ...
          <div className="bg-slate-800/50 border-b border-slate-700/50 px-6 py-4 flex-shrink-0">
            ...
            <div className="flex items-start justify-between gap-4">
              <div className="flex-1">
                ...
                <h2 className="text-xl font-bold text-white mt-2 mb-2 leading-relaxed">{question?.title}</h2>
              ...
              <div className="p-6 space-y-6">
                ...
                <div className="bg-slate-800/40 border border-slate-700/50 rounded-xl p-6">
                  <div className="flex items-start space-x-4">
                    <img
                      ...
                      className="w-12 h-12 rounded-full object-cover flex-shrink-0 ring-2 ring-slate-700"
                    />
                    <div className="flex-1 min-w-0">
                      <div className="flex items-center justify-between mb-3">
                        <div>
                          <h3 className="font-semibold text-white">{question.user.fullName}</h3>
                          <p className="text-sm text-slate-400">@{question.user.username}</p>
                        </div>
                        <button
                ...
                <div>
                  <div className="flex items-center space-x-2 mb-4">
                    ...
                    <h3 className="text-lg font-bold text-white">{question.answersCount} Câu trả lời</h3>
                  </div>
                          ...
                          <div className="flex-1 min-w-0">
                            <div className="flex items-center justify-between mb-2">
                              <div className="flex items-center space-x-2">
                                <h4 className="font-semibold text-white">{answer.user.fullName}</h4>
                                {answer.isAccepted && (
                              ...
                              <span className="text-sm text-slate-400">{formatTimeAgo(answer.createdAt)}</span>
                            </div>
                ...
                <div className="border-t border-slate-700/50 pt-6">
                  <h3 className="text-lg font-bold text-white mb-4">Câu trả lời của bạn</h3>
                  <form onSubmit={handleSubmitAnswer}>
                    ...
                    <div className="flex items-center justify-between mt-3">
                      <p className="text-xs text-slate-500">Hỗ trợ định dạng Markdown: **bold**, *italic*, `code`</p>
                      <button
                        type="submit"
