...
CREATE TABLE `blog_bookmarks` (
  ...
  CONSTRAINT `blog_bookmarks_ibfk_1` FOREIGN KEY (`post_id`) REFERENCES `blog_posts` (`id`) ON DELETE CASCADE,
  CONSTRAINT `blog_bookmarks_ibfk_2` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE CASCADE
...
INSERT INTO `blog_categories` VALUES (1,'Lập trình','lap-trinh','Các bài viết về lập trình và công nghệ','2025-11-03 11:08:23'),(2,'Web Development','web-development','Phát triển web, front-end, back-end','2025-11-03 11:08:23'),(3,'Mobile Development','mobile-development','Phát triển ứng dụng di động','2025-11-03 11:08:23'),(4,'DevOps','devops','DevOps, CI/CD, Cloud','2025-11-03 11:08:23'),(5,'AI & Machine Learning','ai-machine-learning','Trí tuệ nhân tạo và học máy','2025-11-03 11:08:23'),(6,'Career','career','Nghề nghiệp, phỏng vấn, kỹ năng mềm','2025-11-03 11:08:23'),(7,'Tutorials','tutorials','Hướng dẫn chi tiết','2025-11-03 11:08:23'),(8,'Tips & Tricks','tips-tricks','Mẹo vặt và kinh nghiệm','2025-11-03 11:08:23');
...
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `after_comment_like_insert` AFTER INSERT ON `comment_likes` FOR EACH ROW BEGIN
    UPDATE comments 
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `after_comment_like_delete` AFTER DELETE ON `comment_likes` FOR EACH ROW BEGIN
    UPDATE comments 
    SET likes_count = likes_count - 1 
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `after_enrollment_insert` AFTER INSERT ON `enrollments` FOR EACH ROW BEGIN
    UPDATE courses 
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `after_enrollment_delete` AFTER DELETE ON `enrollments` FOR EACH ROW BEGIN
    UPDATE courses 
    SET total_students = total_students - 1 
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `after_forum_reply_insert` AFTER INSERT ON `forum_replies` FOR EACH ROW BEGIN
    UPDATE forum_topics 
...
--
-- Table structure for table `lesson_answer_likes`
--

DROP TABLE IF EXISTS `lesson_answer_likes`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `lesson_answer_likes` (
...
--
-- Dumping data for table `lesson_answer_likes`
--

LOCK TABLES `lesson_answer_likes` WRITE;
/*!40000 ALTER TABLE `lesson_answer_likes` DISABLE KEYS */;
INSERT INTO `lesson_answer_likes` VALUES ('04132a1a-b18b-11f0-abf3-a036bc320b36','d4c8e398-b187-11f0-abf3-a036bc320b36','2396a721-a1e4-11f0-864b-a036bc320b36','2025-10-25 17:11:47');
/*!40000 ALTER TABLE `lesson_answer_likes` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `lesson_answers` (
  ...
  KEY `idx_answer_accepted` (`question_id`,`is_accepted` DESC),
...
INSERT INTO `lesson_answers` VALUES ('d4c8e398-b187-11f0-abf3-a036bc320b36','b13939a9-b187-11f0-abf3-a036bc320b36','2396a721-a1e4-11f0-864b-a036bc320b36','Để học bài học này chỉ cần học full bài học là được.',0,1,'2025-10-25 16:48:59','2025-10-25 17:11:47');
...
--
-- Table structure for table `lesson_question_likes`
--

DROP TABLE IF EXISTS `lesson_question_likes`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `lesson_question_likes` (
  `id` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT (uuid()),
  `question_id` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `user_id` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `created_at` datetime DEFAULT CURRENT_TIMESTAMP,
...
--
-- Dumping data for table `lesson_question_likes`
--

LOCK TABLES `lesson_question_likes` WRITE;
/*!40000 ALTER TABLE `lesson_question_likes` DISABLE KEYS */;
INSERT INTO `lesson_question_likes` VALUES ('da868632-b187-11f0-abf3-a036bc320b36','b13939a9-b187-11f0-abf3-a036bc320b36','2396a721-a1e4-11f0-864b-a036bc320b36','2025-10-25 16:49:09');
/*!40000 ALTER TABLE `lesson_question_likes` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `lesson_questions` (
  ...
  `content` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `status` enum('OPEN','ANSWERED','RESOLVED') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT 'OPEN',
  ...
  KEY `idx_lesson_status` (`lesson_id`,`status`,`created_at` DESC),
  KEY `idx_question_likes_count` (`likes_count` DESC),
...
INSERT INTO `lesson_questions` VALUES ('3a0f41df-b263-11f0-adb0-a036bc320b36','458c78aa-e5fd-4620-af3f-abe9cffde68f','3d4ada88-a4f1-11f0-8481-a036bc320b36','Câu hỏi 1','Nội dung','OPEN',0,4,0,0,'2025-10-26 18:59:29','2025-10-26 18:59:40'),('7f1ba28a-b187-11f0-abf3-a036bc320b36','c8b00894-6a8a-48d9-9e51-e0c7c7e54395','2396a721-a1e4-11f0-864b-a036bc320b36','Làm sao để học bài học này?','**Xin chào**\n\n`Làm sao để học bài học này`','OPEN',0,10,0,0,'2025-10-25 16:46:35','2025-10-25 17:57:09'),('b13939a9-b187-11f0-abf3-a036bc320b36','6696f4eb-d1d7-4e11-bc7a-18d0157068d6','3d4ada88-a4f1-11f0-8481-a036bc320b36','LÀM SAO ĐỂ HỌC BÀI HỌC NÀY','Xin chào. Làm sao để học bài học này?','ANSWERED',0,15,1,1,'2025-10-25 16:48:00','2025-10-25 17:11:43');
...
INSERT INTO `users` VALUES ('11dc6060-9f7e-11f0-ad43-a036bc320b36','huynhkhuanit@gmail.com','$2b$10$eVw2seuMmBSFuVU/3eUXQ.QLNucS51H8r0MD3K7IhiaWGGashgRQS','huynhkhuan','Huynh Van Khuan',NULL,NULL,NULL,'FREE','ADMIN',NULL,0,0,1,0,'2025-10-17 17:11:53','2025-10-02 17:53:46','2025-10-17 17:11:53'),('2396a721-a1e4-11f0-864b-a036bc320b36','huynhkhuan777@gmail.com','$2b$10$YrqH5qV3fjLhmCqU5BaznehpHicnOZ6y791xvmEq1gvdheteTkS3C','huynhkhuanit','Huỳnh Khuân','https://res.cloudinary.com/dhztqlkxo/image/upload/v1760213654/dhvlearnx/avatars/user_2396a721-a1e4-11f0-864b-a036bc320b36.jpg',NULL,'Mình là Khuân, mình sinh viên năm 4 ngành Công Nghệ Phần Mềm Mình là Khuân, mình sinh viên năm 4 ngành Công Nghệ Phần MềmMình là Khuân, mình sinh viên năm 4 ngành Công Nghệ Phần MềmMình là Khuân, mình sinh viên năm 4 ngành Công Nghệ Phần Mềm','PRO','TEACHER','2026-10-12 05:15:45',0,0,1,0,'2025-11-03 02:02:04','2025-10-05 19:09:27','2025-11-03 02:02:04'),('3d4ada88-a4f1-11f0-8481-a036bc320b36','minhun@gmail.com','$2b$10$pxjY3ZdI6J1QTbKxacHF6.kQ9s/TsWRQ2AxCgEIzpwvcmOtnHJfyq','minHun','Do Nguyen Minh Huong','',NULL,'Min Hun 123','PRO','USER','2026-10-12 05:18:25',0,0,1,0,'2025-10-26 18:58:40','2025-10-09 16:20:47','2025-10-26 18:58:40'),('e082d0b0-b269-11f0-adb0-a036bc320b36','huynhkhuan123@gmail.com','$2b$10$DkNkIHBH5HGyOliRN9TkH.noNEFZGGaIRNjhR5NSBvNAO67Pb79ZG','huynhkhuan123','Huynh VanKhuan',NULL,NULL,NULL,'FREE','USER',NULL,0,0,1,0,'2025-10-26 19:47:15','2025-10-26 19:47:05','2025-10-26 19:47:15');
/*!40000 ALTER TABLE `users` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Dumping events for database 'learning_platform_db'
--

--
-- Dumping routines for database 'learning_platform_db'
--
